...
news1 = Label(root,font = "arial 10 bold",fg = "blue",wraplength = 500,justify = LEFT)
...
news2 = Label(root,font = "arial 10 bold",fg = "blue",wraplength = 500,justify = LEFT)
...
news3 = Label(root,font = "arial 10 bold",fg = "blue",wraplength = 500,justify = LEFT)
...
news4 = Label(root,font = "arial 10 bold",fg = "blue",wraplength = 500,justify = LEFT)
...
news5 = Label(root,font = "arial 10 bold",fg = "blue",wraplength = 500,justify = LEFT)
